...
\begin{figure}[htbp]\centering
\input{tablas/DAG1_homogeneizacion}
...
\small
\input{tablas/T6_fuentes_ausentes}
\end{table}
...
\scriptsize
\input{tablas/T9_estructura_derivados}
\end{table}
...
\small
\input{tablas/T7_cobertura_municipal}
\end{table}
...
\small
\input{tablas/T5_cobertura_documental}
\end{table}
