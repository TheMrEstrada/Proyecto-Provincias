...
La Provincia Administrativa y de Planificación Penderisco y Sinifana está conformada por 8 municipios: 6 pertenecen a la subregión SUROESTE y Anzá y Caicedo a la subregión OCCIDENTE. Sobre una extensión de 3.836 km², la Provincia reúne una población proyectada de 138.517 habitantes para 2025, de los cuales el 57,8 % reside en zona rural.
...
Esa desigualdad de tamaño no es un dato administrativo menor. Un municipio como Urrao, con 2.563 km², tiene que llevar servicios a un territorio 31 veces mayor que Angelópolis con una estructura institucional que la categorización municipal no diferencia en la misma proporción. La distancia entre cabeceras, el costo de la red terciaria y el alcance real de cualquier intervención supramunicipal dependen de esta geometría, y conviene tenerla presente al dimensionar las apuestas del Plan.

En el contexto departamental, la Provincia representa el 6,1 % de la superficie de Antioquia.
...
**Tabla 1.** Extensión territorial de los municipios de la Provincia Penderisco y Sinifana
...
| Betulia | 262,37 | 6,8 % |
| Anzá | 255,92 | 6,7 % |
| Concordia | 247,88 | 6,5 % |
| Caicedo | 200,13 | 5,2 % |
| Titiribí | 140,35 | 3,7 % |
| Amagá | 84,13 | 2,2 % |
| Angelópolis | 81,88 | 2,1 % |
| TOTAL PROVINCIA PENDERISCO Y SINIFANA | 3.836,05 | 100,0 % |
...
En su composición, la Provincia es de equilibrio urbano-rural: el 57,8 % de sus habitantes reside en centros poblados y rural disperso. Esa proporción condiciona todo lo que viene después en este diagnóstico —el costo de la cobertura educativa y de salud, la dependencia de la red terciaria, la informalidad laboral— y es el rasgo que más distingue a un territorio como este de la lógica urbana con que suelen diseñarse los instrumentos de planificación.

La densidad poblacional confirma el patrón de ocupación. Amagá (390,6) y Concordia (89,4) registran las densidades más altas y Urrao (12,5) y Anzá (30,0) las más bajas, todas en habitantes por km². La razón entre el extremo alto y el bajo es de 31,3 a 1: dentro de una misma Provincia conviven realidades de poblamiento que exigen respuestas distintas. La densidad provincial en conjunto es de 36,1 hab/km². En el mapa, los 3 municipios con los valores más altos forman una mancha contigua.

La estructura por edad da la medida de esa transición. Los menores de veinte años representan el 29,3 % de la población provincial y los mayores de sesenta el 17,4 %; el grupo más numeroso es el de 10 a 19. La razón de masculinidad es de 99,2 hombres por cada cien mujeres. Una pirámide con la base estrechándose y la cúspide ensanchándose anticipa, en el horizonte del Plan, menos demanda escolar y más demanda de servicios de salud y de cuidado.
...
La tasa neta de migración de la ECV 2023 va de 0,70 a 3,04 entre los municipios de la Provincia, con los valores más altos en Caicedo (3,04) y Amagá (2,76). Conviene notar que en esta fuente el indicador no toma valores negativos en ningún municipio: no puede leerse, por tanto, como un saldo entre quienes llegan y quienes se van, y no sostiene por sí solo una afirmación sobre expulsión de población.
...
**Tabla 2.** Proyecciones de población 2025 en la Provincia Penderisco y Sinifana

| Municipio | Población total | Población urbana | Población rural | Densidad poblacional (hab/km²) |
|---|---|---|---|---|
| Amagá | 32.858 | 16.131 | 16.727 | 390,55 |
| Angelópolis | 6.203 | 2.530 | 3.673 | 75,76 |
| Anzá | 7.681 | 1.602 | 6.079 | 30,01 |
| Betulia | 16.980 | 5.110 | 11.870 | 64,72 |
| Caicedo | 9.107 | 2.083 | 7.024 | 45,51 |
| Concordia | 22.163 | 8.081 | 14.082 | 89,41 |
| Titiribí | 11.537 | 5.355 | 6.182 | 82,20 |
| Urrao | 31.988 | 17.553 | 14.435 | 12,48 |
| TOTAL PROVINCIA PENDERISCO Y SINIFANA | 138.517 | 58.445 | 80.072 | 36,11 |
...
La red terciaria es la que conecta la producción rural con la cabecera y, por lo tanto, la que decide si la vocación agropecuaria de un municipio llega o no al mercado. Medida en kilómetros por km² de territorio, es mayor en Amagá (0,94) y Angelópolis (0,57) y menor en Urrao (0,08) y Titiribí (0,17), con una razón de 12,2 a 1 entre los extremos.

Leída por habitante en vez de por área, la misma red cambia de orden: Anzá (15,37) y Caicedo (8,17) encabezan la Provincia. Las dos lecturas son necesarias. La primera dice cuánto territorio queda sin cubrir; la segunda, cuánta vía sostiene cada habitante, que es lo que pesa sobre la capacidad de mantenimiento del municipio.
...
El tránsito inmediato a la educación superior alcanza el 30,2 % en la Provincia. Es el indicador que cierra el círculo de esta subsección: sin acceso digital ni oferta cercana, la continuidad educativa depende de que el joven se desplace, y el desplazamiento es justamente lo que la dispersión encarece.

El Índice Municipal de Competitividad de Antioquia sitúa a la Provincia en 32,0 sobre 100, encabezada por Amagá (38,1) y Caicedo (32,8). La dimensión de innovación es 0 en todos los municipios de la Provincia; en el conjunto de Antioquia solo un puñado de municipios registra valor positivo, de modo que el cero describe la concentración del indicador antes que una carencia particular de este territorio.
...
El déficit habitacional se mide en dos dimensiones que piden políticas distintas. El déficit **cuantitativo** —hogares sin vivienda o en una irrecuperable— afecta al 3,6 % de las viviendas de la Provincia y se concentra en Anzá (7,5 %) y Caicedo (6,8 %); se resuelve construyendo. El déficit **cualitativo** —vivienda mejorable en materiales, servicios o espacio— afecta al 24,1 % y es más alto en Concordia (42,6 %), Betulia (38,1 %) y Caicedo (23,8 %); se resuelve mejorando lo existente, que es una intervención más barata y de mayor alcance.
...
**Tabla 3.** Déficit cuantitativo y cualitativo de vivienda en la Provincia Penderisco y Sinifana

| Municipio | Déficit cuantitativo de vivienda | Déficit cualitativo de vivienda |
|---|---|---|
| Amagá | 1,9 % | 14,3 % |
| Angelópolis | 4,5 % | 19,9 % |
| Anzá | 7,5 % | 22,1 % |
| Betulia | 3,4 % | 38,1 % |
| Caicedo | 6,8 % | 23,8 % |
| Concordia | 3,4 % | 42,6 % |
| Titiribí | 3,2 % | 18,8 % |
| Urrao | 3,7 % | 17,1 % |
| PROVINCIA PENDERISCO Y SINIFANA (tasa agregada: Σ viviendas con déficit / Σ viviendas) | 3,6 % | 24,1 % |
...
La capacidad de gestión de los municipios determina si una apuesta provincial se ejecuta o se queda en el papel. En la Medición de Desempeño Municipal de 2024, Concordia (64,3) y Titiribí (58,3) obtienen los puntajes más altos de la Provincia y Caicedo (48,4) y Amagá (49,4) los más bajos, con una diferencia de 15,9 puntos entre los extremos.
...
El Índice de Desempeño Fiscal de 2024 ubica a Amagá (65,3) y Betulia (51,5) en la parte alta de la Provincia y a Titiribí (40,7) y Urrao (41,8) en la baja. Como el MDM, tampoco admite promedio provincial. El indicador resume la capacidad de generar recursos propios y de sostener el gasto: es el techo real de cualquier compromiso de cofinanciación que el Plan les pida asumir.

El indicador de la Ley 617 —gastos de funcionamiento sobre ingresos corrientes de libre destinación— se publica por municipio y no se agrega: es un cociente institucional medido contra el techo legal de cada categoría, y no existe un 617 provincial. En la Provincia va de 44,8 % a 69,7 %.
...
El Índice de Ciudades Modernas resume en un solo número seis dimensiones del desarrollo territorial. En 2024, Angelópolis (52,1) y Amagá (50,6) encabezan la Provincia, cuyo promedio ponderado por población es de 44,9, por debajo del departamento (59,2), con una diferencia de 24 %.

Desagregado por dimensiones, el punto más fuerte de la Provincia es equidad e inclusión social (55,5) y el más débil condiciones de vida (30,2). Esa asimetría es más útil para el Plan que el índice agregado: señala dónde una intervención encuentra base sobre la cual construir y dónde tendría que empezar de cero.
...
La pobreza medida por Necesidades Básicas Insatisfechas alcanza sus valores más altos en Betulia (22,6 %), Concordia (21,5 %) y Angelópolis (15,8 %) y los más bajos en Urrao (6,0 %) y Anzá (11,3 %). En el conjunto de la Provincia afecta al 13,9 % de las personas, por encima del departamento (11,4 %), con una diferencia de 2,5 puntos porcentuales. En el mapa, los 3 municipios con los valores más altos forman un patrón parcialmente contiguo.

La lectura urbano-rural es más severa que la agregada: en Concordia, el NBI rural llega al 27,0 %. La pobreza de esta Provincia es fundamentalmente rural, y eso significa que se resuelve con bienes públicos —agua, saneamiento, vía, escuela— antes que con transferencias.

El Índice de Pobreza Multidimensional, que mide privaciones en educación, salud, trabajo y condiciones de la vivienda, sitúa a la Provincia en 20,2 %. Las dos medidas —NBI e IPM— coinciden en el diagnóstico y difieren en el detalle: la primera señala carencias estructurales de la vivienda y la segunda añade las del acceso a servicios y al empleo.

En el mercado laboral, la informalidad promedio de los municipios de la Provincia es del 63,0 % y alcanza sus máximos en Caicedo (85,2 %) y Anzá (82,6 %), con una tasa de ocupación promedio del 51,6 %. La informalidad no es solo un problema de ingresos: define la base tributaria del municipio, el acceso a la seguridad social y la composición del aseguramiento en salud que se describe más adelante.

Entre la población joven, la proporción que no estudia ni trabaja es más alta en Amagá (37,6 %) y Angelópolis (30,7 %). Es el indicador que conecta esta sección con la de educación y con la de seguridad: un joven fuera del sistema educativo y del mercado laboral formal es, en términos de política pública, una oportunidad perdida y un riesgo.
...
La densidad empresarial —empresas registradas por cada mil habitantes— es mayor en Angelópolis (25,16) y Amagá (24,95), con un promedio provincial ponderado de 18,99. Es una medida de formalización tanto como de actividad: donde la densidad es baja, buena parte de la economía existe pero no está registrada, lo que la deja fuera del crédito, de la contratación pública y de los programas de apoyo empresarial.
...
La Provincia alberga 2 centrales de generación con una capacidad efectiva neta de 6,73 MW, encabezadas por MAGALLO (5,70 MW). La generación eléctrica es la actividad que mejor ilustra la pregunta de esta sección: produce valor en el territorio sin que ese valor se traduzca necesariamente en empleo local ni en ingresos municipales más allá de las transferencias del sector.

Esa capacidad representa el 0,1 % de la de Antioquia y el 0,0 % del Sistema Interconectado Nacional.

En minería, la Provincia registra títulos vigentes sobre 44 tipos de mineral. Los más frecuentes son carbón térmico (27 títulos), mineral de oro (21 títulos) y gravas (19 títulos). Se cuentan títulos activos distintos: uno que ampara varios minerales cuenta en cada uno, y uno que cubre varios municipios cuenta una sola vez.
...
En 2026, la Provincia recibió 13 visitantes extranjeros no residentes, el 0,0 % del total departamental. La cifra cuenta visitantes extranjeros, no turistas totales: el turismo interno, que en territorios como este suele ser el grueso, no está en esta fuente.

En instrumentos de planificación turística, 3 de los 8 municipios cuentan con Plan Local de Turismo y 5 con Mesa Local. La capacidad de gestión del turismo antecede a la llegada de visitantes: sin instrumento local, la actividad crece sin ordenamiento y sus beneficios se capturan fuera del municipio.
...
El inventario pecuario de 2025 suma 338.246 cabezas en la Provincia, concentrada: Concordia y Urrao reúnen el 46 % del total. La composición está dominada por porcinos (248.884) y bovinos (84.763). El inventario no incluye aves: la fuente de este flujo no las reporta.

En producción agrícola, 2025 muestra una actividad muy concentrada: Urrao y Betulia concentran el 74 % de las toneladas producidas en la Provincia. Los cultivos permanentes representan el 94,7 % de la producción, frente al 5,3 % de los transitorios. El predominio de permanentes indica una estructura productiva más estable pero también menos flexible ante un cambio de precios, porque la reconversión toma años.

El cultivo permanente principal es aguacate en 3 de los 8 municipios de la Provincia. Que un mismo producto domine en tantos municipios define una vocación compartida, y con ella una oportunidad de acción conjunta —asistencia técnica, acopio, comercialización— que es exactamente el tipo de intervención que justifica un esquema asociativo.

El rendimiento agregado —producción total sobre área cosechada— es mayor en Urrao (12,97) y Titiribí (8,58) y menor en Caicedo (2,71) y Concordia (4,02), con un valor provincial de 7,46 toneladas por hectárea. El rendimiento provincial se recalcula sobre las sumas y no promedia los rendimientos municipales, que darían un número distinto y sobrerrepresentarían a los municipios de menor producción.
...
Las áreas protegidas cubren 529 km² del territorio de la Provincia, el 13,8 % de su superficie, repartidas en 27 registros. La mayor extensión protegida corresponde a Urrao (382 km²). La figura de protección más frecuente es «Distritos Regionales de Manejo Integrado».

En calidad del agua para consumo humano, el IRCA de 2024 registra los niveles de riesgo más altos en Titiribí (54,90) y Amagá (40,60) y los más bajos en Concordia (0,60) y Caicedo (2,20); en este índice un valor mayor significa peor calidad. El promedio provincial es de 18,65. El agua potable es el eslabón donde convergen la dispersión rural, la capacidad institucional del municipio y el déficit cualitativo de vivienda: los tres se manifiestan en el mismo indicador.
...
La pérdida de cobertura arbórea entre 2001 y 2023 se concentra en Concordia (18,0 %), Betulia (13,0 %) y Anzá (7,4 %). El promedio provincial es del 7,4 %, por debajo del departamento (9,3 %), con una diferencia de 1,9 puntos porcentuales. En el mapa, los 3 municipios con los valores más altos forman una mancha contigua.

El Índice Municipal de Riesgo ajustado por capacidades distingue dos amenazas climáticas opuestas. Por exceso de lluvias, los municipios más expuestos son Caicedo (64,53) y Betulia (62,70); por déficit, Betulia (44,05) y Concordia (40,56). Que un mismo territorio aparezca en ambos extremos no es contradictorio: la variabilidad climática se manifiesta en las dos direcciones y exige medidas de adaptación distintas.

En materia de desastres, la emergencia más prevalente es movimiento en masa en 7 de los 8 municipios de la Provincia. Conocer cuál predomina importa porque orienta la inversión en gestión del riesgo hacia un tipo de obra y de sistema de alerta y no hacia otro.

El registro de emergencias muestra la exposición efectiva, no solo la potencial. Entre 2019 y 2024 la Provincia acumuló 350 eventos, con el máximo en 2022 (141 eventos) y el mínimo en 2019 (15). La serie es corta y depende de la capacidad de reporte de cada municipio, de modo que un año con pocos registros no significa necesariamente un año tranquilo.
...
De acuerdo con la información del Ministerio de Educación Nacional para 2024, la Provincia presenta una cobertura neta del 75,0 %, por debajo del departamento (89,9 %), con una diferencia de 14,9 puntos porcentuales. A escala municipal las diferencias internas son significativas: Urrao (83,1 %) y Angelópolis (81,2 %) presentan las coberturas más altas, mientras que Concordia (58,5 %), Titiribí (65,8 %) y Anzá (75,2 %) registran los niveles más bajos.

La permanencia cuenta una historia complementaria. La deserción escolar es mayor en Amagá (5,0 %) y Concordia (3,9 %) y la repitencia en Anzá (12,2 %) y Angelópolis (11,2 %), con una deserción provincial del 3,5 %. Cobertura y permanencia no se mueven necesariamente juntas: un municipio puede matricular bien y perder alumnos durante el año, y ese patrón exige una respuesta distinta —transporte, alimentación, acompañamiento— que la de ampliar cupos.
...
**Tabla 4.** Indicadores educativos de la Provincia Penderisco y Sinifana

| Municipio | Cobertura neta | Tasa de deserción | Tasa de repitencia |
|---|---|---|---|
| Amagá | 77,3 % | 5,0 % | 10,4 % |
| Angelópolis | 81,2 % | 1,0 % | 11,2 % |
| Anzá | 75,2 % | 2,2 % | 12,2 % |
| Betulia | 76,6 % | 2,7 % | 9,8 % |
| Caicedo | 76,8 % | 1,9 % | 8,3 % |
| Concordia | 58,5 % | 3,9 % | 10,1 % |
| Titiribí | 65,8 % | 2,7 % | 9,1 % |
| Urrao | 83,1 % | 3,8 % | 9,9 % |
| PROMEDIO PONDERADO PROVINCIA PENDERISCO Y SINIFANA (por población escolar) | 75,0 % | 3,5 % | 10,1 % |
...
**Tabla 5.** Mortalidad infantil en la Provincia Penderisco y Sinifana

| Municipio | Año | Tasa de mortalidad infantil (x 1.000 nacidos vivos) |
|---|---|---|
| Amagá | 2.024 | 5,03 |
| Angelópolis | 2.024 | 0,00 |
| Anzá | 2.024 | 17,54 |
| Betulia | 2.024 | 7,14 |
| Caicedo | 2.024 | 16,13 |
| Concordia | 2.024 | 9,71 |
| Titiribí | 2.024 | 28,57 |
| Urrao | 2.024 | 18,40 |
| PROMEDIO PONDERADO PROVINCIA PENDERISCO Y SINIFANA (por nacidos vivos) | 2.024 | 12,41 |
...
Las tasas de homicidio más altas de la Provincia corresponden a Betulia (206,1) y Concordia (99,3), con una tasa provincial de 84,5 por cada cien mil habitantes, por encima del departamento (25,3), con una diferencia de 233 %. En el mapa, los 3 municipios con los valores más altos forman una mancha contigua.

Los delitos contra el patrimonio y la violencia intrafamiliar dibujan un mapa distinto: el hurto se concentra en Amagá (137,0) y Caicedo (131,8) y la violencia intrafamiliar en Angelópolis (403,0) y Anzá (247,4). Que no coincidan con la geografía del homicidio es esperable —responden a dinámicas diferentes— y es una razón para no reducir la política de seguridad a un solo indicador.

El Índice de Riesgo de Victimización clasifica a los municipios según su exposición prospectiva. En la Provincia, la categoría más frecuente es «Medio Bajo», con 4 municipios, y los valores más altos corresponden a Urrao (0,3689) y Betulia (0,2033). A diferencia de las tasas de delito, que describen lo ocurrido, el IRV anticipa: es la medida más útil para priorizar prevención.
...
**Tabla 6.** Tasas de delitos de alto impacto en la Provincia Penderisco y Sinifana
...
|---|---|---|---|---|
| Amagá | 36,52 | 136,95 | 246,52 | 42,61 |
| Angelópolis | 48,36 | 32,24 | 403,03 | 96,73 |
| Anzá | 52,08 | 65,10 | 247,36 | 52,08 |
| Betulia | 206,12 | 53,00 | 106,01 | 47,11 |
| Caicedo | 32,94 | 131,77 | 65,88 | 32,94 |
| Concordia | 99,26 | 40,61 | 157,92 | 58,66 |
| Titiribí | 60,67 | 60,67 | 199,36 | 34,67 |
| Urrao | 96,91 | 40,64 | 71,90 | 78,15 |
| TOTAL PROVINCIA PENDERISCO Y SINIFANA | 84,47 | 73,64 | 166,04 | 55,59 |
...
La Provincia registra 102.638 victimizaciones por ocurrencia del conflicto armado, muy concentrada: Urrao y Betulia reúnen el 72 % del total. Son victimizaciones y no personas —una misma persona puede aparecer en más de un hecho—, de modo que la cifra mide la intensidad del daño y no el número de víctimas.

Por tipo de hecho, desplazamiento forzado concentra el 80,0 % de las victimizaciones de la Provincia. La composición del daño importa para la reparación: no se repara igual un desplazamiento que una desaparición o un despojo.

Las solicitudes de restitución de tierras por cada mil habitantes son más altas en Urrao (8,32) y Betulia (5,42). La restitución es el indicador que enlaza el conflicto con el ordenamiento: donde hubo despojo, la formalización de la propiedad rural sigue pendiente.
...
La Unidad de Búsqueda de Personas dadas por Desaparecidas registra 627 casos en la Provincia, muy concentrada: Urrao y Concordia reúnen el 63 % del total. La desaparición forzada es el hecho victimizante con mayor subregistro histórico, de modo que la cifra debe leerse como una cota inferior.
