...
La Provincia Administrativa y de Planificación Bioenergética del Norte de Antioquia está conformada por 13 municipios: 12 pertenecen a la subregión NORTE y Anorí a la subregión NORDESTE. Sobre una extensión de 7.550 km², la Provincia reúne una población proyectada de 175.488 habitantes para 2025, de los cuales el 54,5 % reside en zona rural.
...
Esa desigualdad de tamaño no es un dato administrativo menor. Un municipio como Ituango, con 2.841 km², tiene que llevar servicios a un territorio 24 veces mayor que Guadalupe con una estructura institucional que la categorización municipal no diferencia en la misma proporción. La distancia entre cabeceras, el costo de la red terciaria y el alcance real de cualquier intervención supramunicipal dependen de esta geometría, y conviene tenerla presente al dimensionar las apuestas del Plan.

En el contexto departamental, la Provincia representa el 12,0 % de la superficie de Antioquia.
...
**Tabla 1.** Extensión territorial de los municipios de la Provincia Bioenergética del Norte de Antioquia

| Municipio | Área municipal (km²) | Participación en el área provincial |
|---|---|---|
| Ituango | 2.841,12 | 37,6 % |
| Anorí | 1.413,78 | 18,7 % |
| Yarumal | 738,26 | 9,8 % |
| Valdivia | 567,70 | 7,5 % |
| Briceño | 376,35 | 5,0 % |
| Angostura | 338,67 | 4,5 % |
| Gómez Plata | 332,20 | 4,4 % |
| San Andrés de Cuerquía | 218,73 | 2,9 % |
| Campamento | 206,34 | 2,7 % |
| Carolina del Príncipe | 149,58 | 2,0 % |
| San José de la Montaña | 126,07 | 1,7 % |
| Toledo | 122,58 | 1,6 % |
| Guadalupe | 118,21 | 1,6 % |
| TOTAL PROVINCIA BIOENERGÉTICA DEL NORTE DE ANTIOQUIA | 7.549,58 | 100,0 % |
...
En su composición, la Provincia es de equilibrio urbano-rural: el 54,5 % de sus habitantes reside en centros poblados y rural disperso. Esa proporción condiciona todo lo que viene después en este diagnóstico —el costo de la cobertura educativa y de salud, la dependencia de la red terciaria, la informalidad laboral— y es el rasgo que más distingue a un territorio como este de la lógica urbana con que suelen diseñarse los instrumentos de planificación.

La densidad poblacional confirma el patrón de ocupación. Guadalupe (59,3) y Yarumal (56,7) registran las densidades más altas y Ituango (10,4) y Anorí (14,9) las más bajas, todas en habitantes por km². La razón entre el extremo alto y el bajo es de 5,7 a 1: dentro de una misma Provincia conviven realidades de poblamiento que exigen respuestas distintas. La densidad provincial en conjunto es de 23,2 hab/km². En el mapa, los 3 municipios con los valores más altos forman una mancha contigua.

La estructura por edad da la medida de esa transición. Los menores de veinte años representan el 32,0 % de la población provincial y los mayores de sesenta el 14,5 %; el grupo más numeroso es el de 10 a 19. La razón de masculinidad es de 108,0 hombres por cada cien mujeres. Una pirámide con la base estrechándose y la cúspide ensanchándose anticipa, en el horizonte del Plan, menos demanda escolar y más demanda de servicios de salud y de cuidado.
...
La tasa neta de migración de la ECV 2023 va de 0,00 a 2,51 entre los municipios de la Provincia, con los valores más altos en Campamento (2,51) y Yarumal (2,46). Conviene notar que en esta fuente el indicador no toma valores negativos en ningún municipio: no puede leerse, por tanto, como un saldo entre quienes llegan y quienes se van, y no sostiene por sí solo una afirmación sobre expulsión de población.
...
**Tabla 2.** Proyecciones de población 2025 en la Provincia Bioenergética del Norte de Antioquia

| Municipio | Población total | Población urbana | Población rural | Densidad poblacional (hab/km²) |
|---|---|---|---|---|
| Angostura | 12.511 | 3.144 | 9.367 | 36,94 |
| Anorí | 21.035 | 9.307 | 11.728 | 14,88 |
| Briceño | 7.957 | 2.808 | 5.149 | 21,14 |
| Campamento | 10.005 | 3.029 | 6.976 | 48,49 |
| Carolina del Príncipe | 3.942 | 2.988 | 954 | 26,35 |
| Gómez Plata | 10.373 | 5.578 | 4.795 | 31,22 |
| Guadalupe | 7.009 | 2.562 | 4.447 | 59,29 |
| Ituango | 29.515 | 8.459 | 21.056 | 10,39 |
| San Andrés de Cuerquía | 7.402 | 3.139 | 4.263 | 33,84 |
| San José de la Montaña | 4.017 | 2.599 | 1.418 | 31,86 |
| Toledo | 4.824 | 1.758 | 3.066 | 39,35 |
| Valdivia | 15.014 | 4.414 | 10.600 | 26,45 |
| Yarumal | 41.884 | 30.065 | 11.819 | 56,73 |
| TOTAL PROVINCIA BIOENERGÉTICA DEL NORTE DE ANTIOQUIA | 175.488 | 79.850 | 95.638 | 23,24 |
...
La red terciaria es la que conecta la producción rural con la cabecera y, por lo tanto, la que decide si la vocación agropecuaria de un municipio llega o no al mercado. Medida en kilómetros por km² de territorio, es mayor en Guadalupe (0,52) y Briceño (0,49) y menor en Ituango (0,07) y Carolina del Príncipe (0,15), con una razón de 7,9 a 1 entre los extremos.

Leída por habitante en vez de por área, la misma red cambia de orden: Briceño (21,65) y Anorí (15,38) encabezan la Provincia. Las dos lecturas son necesarias. La primera dice cuánto territorio queda sin cubrir; la segunda, cuánta vía sostiene cada habitante, que es lo que pesa sobre la capacidad de mantenimiento del municipio.
...
El tránsito inmediato a la educación superior alcanza el 31,9 % en la Provincia. Es el indicador que cierra el círculo de esta subsección: sin acceso digital ni oferta cercana, la continuidad educativa depende de que el joven se desplace, y el desplazamiento es justamente lo que la dispersión encarece.

El Índice Municipal de Competitividad de Antioquia sitúa a la Provincia en 30,4 sobre 100, encabezada por Carolina del Príncipe (35,6) y Yarumal (35,0). La dimensión de innovación es 0 en todos los municipios de la Provincia; en el conjunto de Antioquia solo un puñado de municipios registra valor positivo, de modo que el cero describe la concentración del indicador antes que una carencia particular de este territorio.
...
El déficit habitacional se mide en dos dimensiones que piden políticas distintas. El déficit **cuantitativo** —hogares sin vivienda o en una irrecuperable— afecta al 5,0 % de las viviendas de la Provincia y se concentra en Ituango (10,8 %) y Toledo (9,4 %); se resuelve construyendo. El déficit **cualitativo** —vivienda mejorable en materiales, servicios o espacio— afecta al 31,1 % y es más alto en Briceño (55,0 %), San Andrés de Cuerquía (53,3 %) y Campamento (48,3 %); se resuelve mejorando lo existente, que es una intervención más barata y de mayor alcance.
...
**Tabla 3.** Déficit cuantitativo y cualitativo de vivienda en la Provincia Bioenergética del Norte de Antioquia
...
| Briceño | 8,6 % | 55,0 % |
| Campamento | 6,2 % | 48,3 % |
| Carolina del Príncipe | 2,0 % | 14,1 % |
| Gómez Plata | 1,8 % | 21,1 % |
| Guadalupe | 2,6 % | 36,8 % |
| Ituango | 10,8 % | 22,5 % |
| San Andrés de Cuerquía | 5,6 % | 53,3 % |
| San José de la Montaña | 1,3 % | 27,3 % |
| Toledo | 9,4 % | 34,3 % |
| Valdivia | 5,2 % | 43,9 % |
| Yarumal | 1,8 % | 18,0 % |
| PROVINCIA BIOENERGÉTICA DEL NORTE DE ANTIOQUIA (tasa agregada: Σ viviendas con déficit / Σ viviendas) | 5,0 % | 31,1 % |
...
La capacidad de gestión de los municipios determina si una apuesta provincial se ejecuta o se queda en el papel. En la Medición de Desempeño Municipal de 2024, Carolina del Príncipe (71,6) y Valdivia (65,7) obtienen los puntajes más altos de la Provincia y Campamento (37,4) y San José de la Montaña (38,8) los más bajos, con una diferencia de 34,2 puntos entre los extremos.
...
El Índice de Desempeño Fiscal de 2024 ubica a Gómez Plata (69,0) e Ituango (57,1) en la parte alta de la Provincia y a San Andrés de Cuerquía (34,3) y Campamento (40,4) en la baja. Como el MDM, tampoco admite promedio provincial. El indicador resume la capacidad de generar recursos propios y de sostener el gasto: es el techo real de cualquier compromiso de cofinanciación que el Plan les pida asumir.

El indicador de la Ley 617 —gastos de funcionamiento sobre ingresos corrientes de libre destinación— se publica por municipio y no se agrega: es un cociente institucional medido contra el techo legal de cada categoría, y no existe un 617 provincial. En la Provincia va de 0,0 % a 81,0 %.
...
El Índice de Ciudades Modernas resume en un solo número seis dimensiones del desarrollo territorial. En 2024, San José de la Montaña (44,1) y Gómez Plata (43,6) encabezan la Provincia, cuyo promedio ponderado por población es de 39,9, por debajo del departamento (59,2), con una diferencia de 33 %.

Desagregado por dimensiones, el punto más fuerte de la Provincia es equidad e inclusión social (54,6) y el más débil condiciones de vida (21,5). Esa asimetría es más útil para el Plan que el índice agregado: señala dónde una intervención encuentra base sobre la cual construir y dónde tendría que empezar de cero.
...
La pobreza medida por Necesidades Básicas Insatisfechas alcanza sus valores más altos en Anorí (31,0 %), Campamento (28,9 %) y Briceño (28,0 %) y los más bajos en Gómez Plata (9,4 %) y Yarumal (12,2 %). En el conjunto de la Provincia afecta al 19,8 % de las personas, por encima del departamento (11,4 %), con una diferencia de 8,5 puntos porcentuales. En el mapa, los 3 municipios con los valores más altos forman un patrón parcialmente contiguo.

La lectura urbano-rural es más severa que la agregada: en Anorí, el NBI rural llega al 37,8 %. La pobreza de esta Provincia es fundamentalmente rural, y eso significa que se resuelve con bienes públicos —agua, saneamiento, vía, escuela— antes que con transferencias.

El Índice de Pobreza Multidimensional, que mide privaciones en educación, salud, trabajo y condiciones de la vivienda, sitúa a la Provincia en 20,6 %. Las dos medidas —NBI e IPM— coinciden en el diagnóstico y difieren en el detalle: la primera señala carencias estructurales de la vivienda y la segunda añade las del acceso a servicios y al empleo.

En el mercado laboral, la informalidad promedio de los municipios de la Provincia es del 71,0 % y alcanza sus máximos en Ituango (87,2 %) y Valdivia (80,2 %), con una tasa de ocupación promedio del 47,5 %. La informalidad no es solo un problema de ingresos: define la base tributaria del municipio, el acceso a la seguridad social y la composición del aseguramiento en salud que se describe más adelante.

Entre la población joven, la proporción que no estudia ni trabaja es más alta en San José de la Montaña (34,5 %) y Gómez Plata (32,6 %). Es el indicador que conecta esta sección con la de educación y con la de seguridad: un joven fuera del sistema educativo y del mercado laboral formal es, en términos de política pública, una oportunidad perdida y un riesgo.
...
La densidad empresarial —empresas registradas por cada mil habitantes— es mayor en Toledo (29,86) y Yarumal (26,48), con un promedio provincial ponderado de 18,49. Es una medida de formalización tanto como de actividad: donde la densidad es baja, buena parte de la economía existe pero no está registrada, lo que la deja fuera del crédito, de la contratación pública y de los programas de apoyo empresarial.
...
La Provincia alberga 11 centrales de generación con una capacidad efectiva neta de 2.428,30 MW, encabezadas por ITUANGO (1.200,00 MW). La generación eléctrica es la actividad que mejor ilustra la pregunta de esta sección: produce valor en el territorio sin que ese valor se traduzca necesariamente en empleo local ni en ingresos municipales más allá de las transferencias del sector.

Esa capacidad representa el 38,2 % de la de Antioquia y el 10,6 % del Sistema Interconectado Nacional.

En minería, la Provincia registra títulos vigentes sobre 33 tipos de mineral. Los más frecuentes son mineral de oro (49 títulos), carbón metalúrgico (25 títulos) y carbón térmico (22 títulos). Se cuentan títulos activos distintos: uno que ampara varios minerales cuenta en cada uno, y uno que cubre varios municipios cuenta una sola vez.
...
En 2026, la Provincia recibió 18 visitantes extranjeros no residentes, el 0,0 % del total departamental. La cifra cuenta visitantes extranjeros, no turistas totales: el turismo interno, que en territorios como este suele ser el grueso, no está en esta fuente.

En instrumentos de planificación turística, 5 de los 13 municipios cuentan con Plan Local de Turismo y 8 con Mesa Local. La capacidad de gestión del turismo antecede a la llegada de visitantes: sin instrumento local, la actividad crece sin ordenamiento y sus beneficios se capturan fuera del municipio.
...
El inventario pecuario de 2025 suma 469.301 cabezas en la Provincia, muy concentrada: Yarumal y Gómez Plata reúnen el 47 % del total. La composición está dominada por bovinos (274.946) y porcinos (180.307). El inventario no incluye aves: la fuente de este flujo no las reporta.

En producción agrícola, 2025 muestra una actividad muy concentrada: Campamento y Angostura concentran el 57 % de las toneladas producidas en la Provincia. Los cultivos permanentes representan el 93,6 % de la producción, frente al 6,4 % de los transitorios. El predominio de permanentes indica una estructura productiva más estable pero también menos flexible ante un cambio de precios, porque la reconversión toma años.

El cultivo permanente principal es caña en 8 de los 13 municipios de la Provincia. Que un mismo producto domine en tantos municipios define una vocación compartida, y con ella una oportunidad de acción conjunta —asistencia técnica, acopio, comercialización— que es exactamente el tipo de intervención que justifica un esquema asociativo.

El rendimiento agregado —producción total sobre área cosechada— es mayor en Campamento (36,18) y Angostura (26,85) y menor en Toledo (2,05) y Valdivia (3,44), con un valor provincial de 17,97 toneladas por hectárea. El rendimiento provincial se recalcula sobre las sumas y no promedia los rendimientos municipales, que darían un número distinto y sobrerrepresentarían a los municipios de menor producción.
...
Las áreas protegidas cubren 1.557 km² del territorio de la Provincia, el 20,6 % de su superficie, repartidas en 7 registros. La mayor extensión protegida corresponde a Ituango (1.206 km²). La figura de protección más frecuente es «Distritos Regionales de Manejo Integrado».

En calidad del agua para consumo humano, el IRCA de 2024 registra los niveles de riesgo más altos en Angostura (6,30) y Gómez Plata (4,60) y los más bajos en Ituango (0,00) y Guadalupe (0,90); en este índice un valor mayor significa peor calidad. El promedio provincial es de 2,18. El agua potable es el eslabón donde convergen la dispersión rural, la capacidad institucional del municipio y el déficit cualitativo de vivienda: los tres se manifiestan en el mismo indicador.
...
La pérdida de cobertura arbórea entre 2001 y 2023 se concentra en Angostura (22,0 %), Anorí (13,0 %) y Valdivia (11,0 %). El promedio provincial es del 7,8 %, por debajo del departamento (9,3 %), con una diferencia de 1,5 puntos porcentuales. En el mapa, los 3 municipios con los valores más altos forman un patrón parcialmente contiguo.

El Índice Municipal de Riesgo ajustado por capacidades distingue dos amenazas climáticas opuestas. Por exceso de lluvias, los municipios más expuestos son Valdivia (68,30) e Ituango (65,68); por déficit, Valdivia (31,64) y Briceño (30,61). Que un mismo territorio aparezca en ambos extremos no es contradictorio: la variabilidad climática se manifiesta en las dos direcciones y exige medidas de adaptación distintas.

En materia de desastres, la emergencia más prevalente es movimiento en masa en 9 de los 13 municipios de la Provincia. Conocer cuál predomina importa porque orienta la inversión en gestión del riesgo hacia un tipo de obra y de sistema de alerta y no hacia otro.

El registro de emergencias muestra la exposición efectiva, no solo la potencial. Entre 2019 y 2024 la Provincia acumuló 280 eventos, con el máximo en 2022 (102 eventos) y el mínimo en 2019 (11). La serie es corta y depende de la capacidad de reporte de cada municipio, de modo que un año con pocos registros no significa necesariamente un año tranquilo.
...
De acuerdo con la información del Ministerio de Educación Nacional para 2024, la Provincia presenta una cobertura neta del 70,1 %, por debajo del departamento (89,9 %), con una diferencia de 19,8 puntos porcentuales. A escala municipal las diferencias internas son significativas: Toledo (87,3 %) y Carolina del Príncipe (84,3 %) presentan las coberturas más altas, mientras que San José de la Montaña (57,2 %), Briceño (61,1 %) y Gómez Plata (63,2 %) registran los niveles más bajos.

La permanencia cuenta una historia complementaria. La deserción escolar es mayor en Anorí (5,9 %) y Gómez Plata (5,0 %) y la repitencia en Carolina del Príncipe (12,8 %) y Valdivia (10,5 %), con una deserción provincial del 3,4 %. Cobertura y permanencia no se mueven necesariamente juntas: un municipio puede matricular bien y perder alumnos durante el año, y ese patrón exige una respuesta distinta —transporte, alimentación, acompañamiento— que la de ampliar cupos.
...
**Tabla 4.** Indicadores educativos de la Provincia Bioenergética del Norte de Antioquia

| Municipio | Cobertura neta | Tasa de deserción | Tasa de repitencia |
|---|---|---|---|
| Angostura | 66,5 % | 3,0 % | 5,4 % |
| Anorí | 69,6 % | 5,9 % | 6,4 % |
| Briceño | 61,1 % | 2,8 % | 6,8 % |
| Campamento | 63,7 % | 3,7 % | 6,9 % |
...
| Toledo | 87,3 % | 3,2 % | 9,9 % |
| Valdivia | 71,2 % | 3,6 % | 10,5 % |
| Yarumal | 77,2 % | 2,3 % | 8,5 % |
| PROMEDIO PONDERADO PROVINCIA BIOENERGÉTICA DEL NORTE DE ANTIOQUIA (por población escolar) | 70,1 % | 3,4 % | 7,7 % |
...
**Tabla 5.** Mortalidad infantil en la Provincia Bioenergética del Norte de Antioquia

| Municipio | Año | Tasa de mortalidad infantil (x 1.000 nacidos vivos) |
|---|---|---|
| Angostura | 2.024 | 13,89 |
| Anorí | 2.024 | 5,49 |
| Briceño | 2.024 | 0,00 |
| Campamento | 2.024 | 0,00 |
| Carolina del Príncipe | 2.024 | 0,00 |
| Gómez Plata | 2.024 | 0,00 |
| Guadalupe | 2.024 | 0,00 |
| Ituango | 2.024 | 6,29 |
| San Andrés de Cuerquía | 2.024 | 23,26 |
| San José de la Montaña | 2.024 | 0,00 |
| Toledo | 2.024 | 0,00 |
| Valdivia | 2.024 | 0,00 |
| Yarumal | 2.024 | 9,17 |
| PROMEDIO PONDERADO PROVINCIA BIOENERGÉTICA DEL NORTE DE ANTIOQUIA (por nacidos vivos) | 2.024 | 6,05 |
...
Las tasas de homicidio más altas de la Provincia corresponden a San Andrés de Cuerquía (391,8) y Briceño (226,2), con una tasa provincial de 111,7 por cada cien mil habitantes, por encima del departamento (25,3), con una diferencia de 341 %. En el mapa, los 3 municipios con los valores más altos forman un patrón parcialmente contiguo.

Los delitos contra el patrimonio y la violencia intrafamiliar dibujan un mapa distinto: el hurto se concentra en Yarumal (121,8) y Carolina del Príncipe (101,5) y la violencia intrafamiliar en Carolina del Príncipe (304,4) y Toledo (248,8). Que no coincidan con la geografía del homicidio es esperable —responden a dinámicas diferentes— y es una razón para no reducir la política de seguridad a un solo indicador.

El Índice de Riesgo de Victimización clasifica a los municipios según su exposición prospectiva. En la Provincia, la categoría más frecuente es «Alto», con 5 municipios, y los valores más altos corresponden a Briceño (0,8416) e Ituango (0,8337). A diferencia de las tasas de delito, que describen lo ocurrido, el IRV anticipa: es la medida más útil para priorizar prevención.
...
**Tabla 6.** Tasas de delitos de alto impacto en la Provincia Bioenergética del Norte de Antioquia
...
|---|---|---|---|---|
| Angostura | 55,95 | 15,99 | 103,91 | 31,97 |
| Anorí | 218,68 | 33,28 | 99,83 | 71,31 |
| Briceño | 226,22 | 12,57 | 188,51 | 62,84 |
| Campamento | 99,95 | 10,00 | 49,98 | 79,96 |
| Carolina del Príncipe | 76,10 | 101,47 | 304,41 | 50,74 |
| Guadalupe | 42,80 | 28,53 | 99,87 | 71,34 |
| Gómez Plata | 57,84 | 48,20 | 96,40 | 57,84 |
| Ituango | 71,15 | 10,16 | 40,66 | 166,02 |
| San Andrés de Cuerquía | 391,79 | 54,04 | 202,65 | 67,55 |
| San José de la Montaña | 74,68 | 49,79 | 199,15 | 49,79 |
| Toledo | 124,38 | 20,73 | 248,76 | 41,46 |
| Valdivia | 126,55 | 26,64 | 0,00 | 0,00 |
| Yarumal | 59,69 | 121,76 | 167,13 | 69,24 |
| TOTAL PROVINCIA BIOENERGÉTICA DEL NORTE DE ANTIOQUIA | 111,69 | 49,58 | 113,97 | 75,22 |
...
La Provincia registra 181.813 victimizaciones por ocurrencia del conflicto armado, concentrada: Ituango y Valdivia reúnen el 46 % del total. Son victimizaciones y no personas —una misma persona puede aparecer en más de un hecho—, de modo que la cifra mide la intensidad del daño y no el número de víctimas.

Por tipo de hecho, desplazamiento forzado concentra el 71,9 % de las victimizaciones de la Provincia. La composición del daño importa para la reparación: no se repara igual un desplazamiento que una desaparición o un despojo.

Las solicitudes de restitución de tierras por cada mil habitantes son más altas en Ituango (15,08) y Briceño (14,70). La restitución es el indicador que enlaza el conflicto con el ordenamiento: donde hubo despojo, la formalización de la propiedad rural sigue pendiente.

En economías ilegales, la Provincia registra 9.394,31 hectáreas de coca, concentradas en Valdivia (4.726,85) y Anorí (2.089,32). Solo aparecen los municipios donde la fuente detectó cultivo: la ausencia de un municipio significa cero, no falta de dato.
...
La Unidad de Búsqueda de Personas dadas por Desaparecidas registra 1.427 casos en la Provincia, muy concentrada: Ituango y Valdivia reúnen el 55 % del total. La desaparición forzada es el hecho victimizante con mayor subregistro histórico, de modo que la cifra debe leerse como una cota inferior.
